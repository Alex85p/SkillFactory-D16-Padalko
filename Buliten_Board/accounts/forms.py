...
class SignUpForm(UserCreationForm):
    """
        ...
        Методы:
            clean_email(): Проверка уникальности введенного email адреса.
            save(commit=True): Создание и сохранение нового пользователя после регистрации.
            send_verification_email(email, verification_code, pk): Отправка письма с кодом подтверждения
